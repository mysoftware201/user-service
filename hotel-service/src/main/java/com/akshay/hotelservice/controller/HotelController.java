package com.akshay.hotelservice.controller;
...
import com.akshay.hotelservice.service.HotelService;
...
public class HotelController 
{
	...
	//get one
	@GetMapping("/{hotelId}")
	ResponseEntity<Hotel> gethotelId(@PathVariable String hotelId)
	{
